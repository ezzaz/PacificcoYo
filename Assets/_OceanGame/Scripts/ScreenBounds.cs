...
public class ScreenBounds : MonoBehaviour
{
    ...
    private void Awake()
   {
        this.mainCamara.transform.localScale = Vector3.one;
   ...
   {
        float ySize = mainCamara.orthographicSize * 2;
        Vector2 boxColliderSize = new Vector2(ySize * mainCamara.aspect, ySize);
