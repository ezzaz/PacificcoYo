...
public class Dialogos : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Keyboard.current.eKey.wasPressedThisFrame && !esCinematica)
        {
            if (!didDialogueStart)
            {
                StartDialogue();
            }
            else if (dialogueText.text == dialogueLines[lineIndex].text)
            {
                NextDialogueLine();
            }
            else
        ...
        else if (Keyboard.current.eKey.wasPressedThisFrame && esCinematica)
        {
            if (!didDialogueStart)
            {
                StartDialogue();
